...
"""
Preprocess HotPotQA into JSONL for the abstention_proto_v2 environment.
...
abstention_proto_v2 resources server.  Like V1, this version:
...
def build_record(row: dict, idx: int) -> dict:
    """Convert a single HotPotQA row into an abstention_proto_v2 record."""
    ...
    return {
        ...
        "agent_ref": {
            ...
            "name": "abstention_proto_v2_simple_agent",
        },
...
def main():
    parser = argparse.ArgumentParser(description="Preprocess HotPotQA for abstention_proto_v2")
    parser.add_argument(
        "--download",
        action="store_true",
